...
/**
 * _myhistory - the history list is shown, one command per line, preceded
 ...
 * @info: it shows parameter structure
 * @str: this is the string alias
 *
 * Return: display 0 on success and 1 on error
 */
 ...
 * Return: show 0 on success, 1 on error
 */
 ...
 * @info: Layout featuring possible arguments. it's used to maintain
 * constant function prototype.
